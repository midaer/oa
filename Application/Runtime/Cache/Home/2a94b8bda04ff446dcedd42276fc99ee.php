                    ...
                    <div class="sidebar">
                        ...
                        <ul class="nav">
                            <li class="konwledge">
                                ...
                                <ul class="subnav">
                                    <li><a href="javascript:;" date-src="<?php echo U('Knowlege/lst');?>">知识列表</a></li>
                                    <li><a href="javascript:;" date-src="<?php echo U('Knowlege/add');?>">添加知识</a></li>
                                    <li><a href="javascript:;" date-src="<?php echo U('Knowlege/manual');?>">知识手册</a></li>
                                </ul>
                            </li>
...
<!--                            <li class="office current">
            ...
            <div id="ft" class="ue-clear">
                <div class="ft-left"> <span>米达</span> <em>Office&nbsp;System</em> </div>
